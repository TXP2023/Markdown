...
有n堆石头， 每次操作可以将n堆石头中第 $[l,r]$ 的所有石头全不挪到 $[l,r]$ 中随机一堆里头。 问每个石头在所有操作后的期望石头数量

# Slove

每次模拟可以先计算出区间和，然后计算出期望值，赋给区间里头每堆，很容易发现是区间问题，使用线段树解决。 由于涉及除法取模，所以要使用逆元
